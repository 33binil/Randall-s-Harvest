            ...
            >
                ...
                <div className="mt-28 mb-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    {[
                        ...
                        { title: "Cumin Seeds", image: "/cuminseed.png", href: "https://en.wikipedia.org/wiki/Cumin", desc: "Cumin is a warm, earthy spice made from dried seeds, known for its nutty, slightly peppery flavor that adds depth to curries, stews, and spice blends." },
                        { title: "Coriander Seeds", image: "/corriander.png", href: "https://en.wikipedia.org/wiki/Coriander", desc: "Coriander seed is a fragrant spice with a warm, citrusy, and slightly sweet flavor, commonly used in curries, pickles, and spice blends." },
                        { title: "Toasted Sesame Seeds", image: "/toastedseasame.png", href: "https://en.wikipedia.org/wiki/Sesame", desc: "Toasted sesame seeds have a rich, nutty flavor and a crunchy texture, perfect for sprinkling on breads, salads, and stir-fries." },
                        { title: "Light Citrus", image: "/citrus.png", href: "https://en.wikipedia.org/wiki/Citrus", desc: "Delivers light citrus notes that brighten and balance the spice blend." },
                        { title: "Rosemary Seeds", image: "/rosemarseeds.png", href: "https://en.wikipedia.org/wiki/Rosmarinus_officinalis", desc: "Rosemary seeds grow into a fragrant herb with a pine-like flavor, perfect for seasoning meats, breads, and Mediterranean dishes." },
                        { title: "Cracked Fennel", image: "/crackedfennel.png", href: "https://en.wikipedia.org/wiki/Fennel", desc: "Cracked fennel has a sweet, slightly licorice-like flavor, perfect for adding aroma and depth to breads, sausages, and spice blends." },
                    ].map((item, idx) => (
                        <a
                            key={idx}
                            href={item.href}
